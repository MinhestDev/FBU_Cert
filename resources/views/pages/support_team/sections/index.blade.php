...
@section('page_title', 'Quản lý Các Khối Lớp')
@section('content')
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <form class="ajax-store" method="post" action="{{ route('sections.store') }}">
                                ...
                                <div class="form-group row">
                                    <label for="my_class_id" class="col-lg-3 col-form-label font-weight-semibold">Chọn Lớp <span class="text-danger">*</span></label>
                                    <div class="col-lg-9">
                                ...
                                <div class="text-right">
                                    <button type="submit" class="btn btn-primary">Gửi form <i class="icon-paperplane ml-2"></i></button>
                                </div>
                            </form>
                        </div>
                    </div>
                                        ...
                                        <div class="list-icons">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-left">
                                                    {{--Chỉnh sửa--}}
                                                    @if(Qs::userIsTeamSA())
                                                        <a href="{{ route('sections.edit', $s->id) }}" class="dropdown-item"><i class="icon-pencil"></i> Chỉnh sửa</a>
                                                    @endif
                                                    {{--Xóa--}}
