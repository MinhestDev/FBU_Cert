...
@section('page_title', 'Học sinh tốt nghiệp')
@section('content')

<div class="card">
    <div class="card-header header-elements-inline">
        <h6 class="card-title">Học sinh đã tốt nghiệp</h6>
        {!! Qs::getPanelOptions() !!}
    </div>

    <div class="card-body">
        <ul class="nav nav-tabs nav-tabs-highlight">
            <li class="nav-item"><a href="#all-students" class="nav-link active" data-toggle="tab">Tất cả học sinh đã tốt nghiệp</a></li>
            <li class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Chọn lớp</a>
            ...
            <div class="tab-pane fade show active" id="all-students">
                <table class="table datatable-button-html5-columns">
                    ...
                    <tr>
                        ...
                        <td><img class="rounded-circle" style="height: 40px; width: 40px;" src="{{ $s->user->photo }}" alt="Ảnh"></td>
                        <td>{{ $s->user->name }}</td>
                        <td>{{ $s->adm_no }}</td>
                            ...
                            <div class="list-icons">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-left">
                                        ...
                                        {{--Không tốt nghiệp--}}
                                        <a id="{{ Qs::hash($s->id) }}" href="#" onclick="$('form#ng-'+this.id).submit();" class="dropdown-item"><i class="icon-stairs-down"></i> Không tốt nghiệp</a>
